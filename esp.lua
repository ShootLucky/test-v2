...
-- Configures background properties (Lunar style)
Background_1.Parent = KeySystem
Background_1.AnchorPoint = Vector2.new(0.5, 0.5)
Background_1.BackgroundColor3 = Color3.fromRGB(15, 15, 25) -- Dark space blue
...
-- Configures exit button (Lunar style)
...
ExitButton.Image = "rbxassetid://9545003266" -- Moon-like icon
ExitButton.ZIndex = 2
ExitButton.Size = UDim2.new(0, 40, 0, 40)
ExitButton.ImageTransparency = 0.77
ExitButton.ImageColor3 = Color3.fromRGB(200, 220, 255) -- Moon glow color

-- Adds corner rounding to background
UICorner_1.Parent = Background_1
UICorner_1.CornerRadius = UDim.new(0, 8) -- Slightly more rounded for lunar feel
...
-- Configures first section frame (Lunar style)
First_1.Parent = List_1
First_1.BackgroundColor3 = Color3.fromRGB(25, 25, 40) -- Darker space blue
...
-- Configures description label (Lunar style)
...
Desc_1.TextColor3 = Color3.fromRGB(180, 200, 255) -- Soft blue-white
Desc_1.TextSize = 18
Desc_1.TextYAlignment = Enum.TextYAlignment.Top

-- Configures title label (Lunar style)
...
Nam_1.Font = Enum.Font.GothamBold
Nam_1.Text = Settings.Title
Nam_1.TextColor3 = Color3.fromRGB(220, 230, 255) -- Bright moon color
Nam_1.TextSize = 32
Nam_1.TextXAlignment = Enum.TextXAlignment.Right

-- Adds logo if provided (Lunar style)
if Settings.Logo ~= nil then
    Ico_1.Parent = Nam_1
    Ico_1.AnchorPoint = Vector2.new(1, 0.5)
    Ico_1.BackgroundColor3 = Color3.fromRGB(25, 25, 40)
    Ico_1.BorderSizePixel = 0
    Ico_1.Position = UDim2.new(0, 0, 0.5, 0)
    Ico_1.Size = UDim2.new(0, 50, 0, 50)
    Ico_1.Image = Settings.Logo
    Ico_1.ImageColor3 = Color3.fromRGB(220, 230, 255)
...
-- Configures second section frame (Lunar style)
Second_1.Parent = List_1
Second_1.BackgroundColor3 = Color3.fromRGB(25, 25, 40)
...
-- Configures key input frame (Lunar style)
KeyFrame_1.Parent = Second_1
KeyFrame_1.AnchorPoint = Vector2.new(0.5, 0.5)
KeyFrame_1.BackgroundColor3 = Color3.fromRGB(35, 35, 55) -- Darker input field
...
-- Adds stroke to key frame (Lunar glow)
UIStroke_1.Parent = KeyFrame_1
UIStroke_1.Color = Color3.fromRGB(150, 180, 255) -- Soft blue glow
...
-- Configures key input textbox (Lunar style)
...
KeyBox_1.Font = Enum.Font.Gotham
...
KeyBox_1.TextColor3 = Color3.fromRGB(220, 230, 255) -- Moon glow text
KeyBox_1.TextSize = 18
KeyBox_1.TextXAlignment = Enum.TextXAlignment.Left

-- Configures placeholder text (Lunar style)
EnterText_1.Parent = KeyBox_1
EnterText_1.AnchorPoint = Vector2.new(0, 0.5)
EnterText_1.BackgroundColor3 = Color3.fromRGB(35, 35, 55)
EnterText_1.BorderColor3 = Color3.fromRGB(0, 0, 0)
EnterText_1.BorderSizePixel = 0
EnterText_1.TextTransparency = 0.5
EnterText_1.Position = UDim2.new(0, 0, 0.5, 0)
EnterText_1.Size = UDim2.new(0, 80, 0, 20)
EnterText_1.Font = Enum.Font.Gotham
EnterText_1.Text = "Enter key"
EnterText_1.TextColor3 = Color3.fromRGB(150, 180, 255) -- Soft blue
EnterText_1.TextSize = 16
EnterText_1.TextXAlignment = Enum.TextXAlignment.Center

-- Configures third section frame (Lunar style)
third_1.Parent = List_1
third_1.BackgroundColor3 = Color3.fromRGB(25, 25, 40)
...
local function CreateButton(text, color, callback)
    ...
    LinkButton_1.Font = Enum.Font.GothamBold

    -- Adds stroke to button (Lunar glow)
    ...
    -- Handles button hover effects (Lunar glow)
    LinkButton_1.MouseEnter:Connect(function()
        LinkButton_1.BackgroundTransparency = 0.8
    ...
    -- Handles button click with animation (Lunar effect)
    if UIS.MouseEnabled then
        ...
        LinkButton_1.MouseButton1Click:Connect(function()
            ...
            for i = 1, 10 do
                c.ImageTransparency = c.ImageTransparency + 0.04
                wait(len / 12)
            end
            c:Destroy()
        end)
        ...
        LinkButton_1.MouseButton1Click:Connect(function()
            ...
            LinkButton_1.BackgroundTransparency = 0.7
            wait(.2)
